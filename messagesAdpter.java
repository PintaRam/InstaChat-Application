...
import static com.example.mychat.chatWIn.reciverIImg;

import static com.example.mychat.chatWIn.senderIImg;
...
public class messagesAdpter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == senderViewHolder.class)
        {
            ...
            Picasso.get().load(senderIImg).into(viewHolder.circleImageView);
